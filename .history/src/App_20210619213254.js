...
*/}
            ...
            <div>
              ...
              <Row className="">
                <Button className="col-md-3 col-sm-6 col-xs-12 footerbottom">
                  Terms & Conditions
                </Button>
                <div className="col-md-2 col-sm-6 col-xs-12  footerbottom">
                  Privacy
                </div>
                <div className="col-md-2 col-sm-6 col-xs-12 footerbottom">
                  Cookies
                ...
                <div className="col-md-3 col-sm-6 col-xs-12  footerbottom">
                  Acknowledgments
                </div>
              </Row>
            </div>
