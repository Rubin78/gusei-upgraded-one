...
import song4 from "./assests/song4.png";
          ...
          <Row>
            ...
            <div className="col-md-6">
              ...
              <div className=" col-sm-12 songplaylist">
                {/*  <div className=" col-9 songplaylistitem">
                  <div className="col-12  songplaylistiteminner">
                    <div className="col-md-4 col-sm-5 songimage">
                      <img className="songimage1" src={song1} />
                    </div>

                    <div className=" col-7 songtext">
                      <div className="songtextinside">
>                        <div>
                          <div className="texthes"> If The World</div>
                          <div className="texthes"> Was Ending</div>
                        </div>
                ...
                <div className="songbuttoncards">
                  ...
                  <div className=" col-sm-7 col-xs-5 songdescriptionsn">

                    <div className=" col-sm-10 col-xs-10 songtext">
                      <div className="songtextinside">
                    <div>
                      <div className="texthes"> If The World</div>
                      <div className="texthes"> Was Ending</div>
                ...
                <div className=" col-9 songplaylistitem">
                  <div className="col-12  songplaylistiteminner">
                    <div className="col-md-4 col-sm-5 songimage">
                      <img className="songimage1" src={song2} />
                    </div>

                    <div className=" col-7 songtext">
                      <div className="songtextinside">
                        <div>
                          <div className="texthes"> Trampoline</div>
                        </div>
                        <div className=" songparagrah">by SHAED </div>
                        <div className=" iconssongs">
                          <div className="col-1">
                            <img src="data:image/png;base64," />
                          </div>
                ...
                <div className=" col-9 songplaylistitem">
                  <div className="col-12  songplaylistiteminner">
                    <div className="col-md-4 col-sm-5 songimage">
                      <img className="songimage1" src={song3} />
                    </div>

                    <div className=" col-7 songtext">
                      <div className="songtextinside">
                        <div>
                          <div className="texthes"> Sweet but </div>
                          <div className="texthes"> Psycho</div>
                        </div>
                        <div className=" songparagrah">by Ava Max </div>
                        <div className=" iconssongs">
                          <div className="col-1">
                            <img src="data:image/png;base64," />
                          </div>
                          <div className="">1.6K</div>{" "}
                          <div className="col-1">
                            <img src="data:image/png;base64," />
                          </div>
                ...
                <div className=" col-9 songplaylistitem">
                  <div className="col-12  songplaylistiteminner">
                    <div className="col-md-4 col-sm-5 songimage">
                      <img className="songimage1" src={song4} />
                    </div>

                    <div className=" col-7 songtext">
                      <div className="songtextinside">
                        <div>
                          <div className="texthes">Lovely</div>
                        </div>
                        <div className=" songparagrah">
                          by Billie Eilish & Khalid{" "}
                        </div>
                        <div className=" iconssongs">
                          <div className="col-1">
                            <img src="data:image/png;base64," />
                          </div>
                          <div className="">1.2K</div>{" "}
                          <div className="col-1">
                            <img src="data:image/png;base64," />
                          </div>
                          <div className="col-1"> 24</div>{" "}
...
*/}
            ...
            <div>
              <Row className="">
                <div className="col-md-3 col-sm-12 footerbottom">
                  Terms & Conditions
                </div>
                <div className="col-md-2 col-sm-12 footerbottom">Privacy</div>
                <div className="col-md-2 col-sm-12 footerbottom">Cookies</div>
                <div className="col-md-2 col-sm-12 footerbottom">
                  Copyright{" "}
                </div>
                <div className="col-md-3 col-sm-12 footerbottom">
                  Acknowledgments
            ...
            <div className="col-12 copyright ">
              © 2020 Gusei Pvt. Ltd., Inc. All Rights Reserved.
            </div>
          </div>
        </div>
      </footer>
