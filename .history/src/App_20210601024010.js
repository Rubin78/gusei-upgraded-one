      ...
      <div className="section4">
        ...
        <div className="descriptioncard">
          <div className="descriptioncardinner">
            ...
            If anyone love music ,wake up humming, play a mean air guitar,cant't
            stop singing in the shower, or dream of rocking out in a punk
            ukulele band,join us who knows might just find your harmonious
            doppelganger or melodic twin seperated at birth. Anyone can do it
            .Np Previous experience required. letss music together.
             </div>
            </div>
          </div>
        </div>
