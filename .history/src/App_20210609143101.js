          ...
          <Row>
            ...
            <div className="col-md-6">
              ...
              <div className=" col-sm-12 songplaylist">
                ...
                <div className=" col-md-10 songplaylistitem">
                  <div className=" col-10 songplaylistiteminner">
                    <div className=" col-4 songplaylistiteminner">dkkd</div>

                    <div className=" col-6 songplaylistiteminner">domd</div>
