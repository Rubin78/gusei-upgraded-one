        ...
        <div className="descriptioncard">
          <div className="descriptioncardinner">
            ...
            <div className="descriptioncardtext">
              ...
              empower anyone to join in. Today, we’re a vibrant, global
              ...
              make new friends, cheer each other on, and simply have fun. If you
              love music, wake up humming, play a mean air guitar, can’t stop
              singing in the shower, or dream of rocking out in a punk ukulele
              band, join us. Who knows, you might just find your harmonious
              doppelganger or melodic twin separated at birth. Anyone can do it.
              No previous experience required. Let’s music together.
            </div>
            <div className="descriptioncardtext">
              <div className="descriptioncardtextinner">
                when we started in,2020,Gusei was just a company with a fun name
