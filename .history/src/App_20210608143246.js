...
*/}
            <div className="dmc">
              <Row>
                <div className="col-sm-4">ssss</div>

                <div className="col-sm-4">odkkdkkd</div>

                <div className="col-sm-4">sosoosos</div>
            ...
            <div>
              <Row className="">
                <div className="col-3 footerbottom">Terms & Conditions</div>
                <div className="col-2 footerbottom">Privacy</div>
                <div className="col-2 footerbottom">Cookies</div>
                <div className="col-2 footerbottom">Copyright </div>
                <div className="col-3 footerbottom">Acknowledgments</div>
              </Row>
            </div>
