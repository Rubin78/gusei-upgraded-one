          ...
          <div className="descriptioncardinner">
            ...
            <div className="descriptioncardtext">
              <div className="descriptioncardtextinner">
                ...
                world together. When we started in 2020, Gusei was just a
                company with a fun name and a big dream. We wanted to bring
                music back to its roots and empower anyone to join in. Today,
                we’re a vibrant, global community of music lovers where millions
                of people across the world come together each day to share their
                passion for music, make new friends, cheer each other on, and
                simply have fun. If you love music, wake up humming, play a mean
                air guitar, can’t stop singing in the shower, or dream of
                rocking out in a punk ukulele band, join us. Who knows, you
                might just find your harmonious doppelganger or melodic twin
                separated at birth. Anyone can do it. No previous experience
                required. Let’s music together.
              </div>
            </div>
            <div className="descriptioncardtext">
              <div className="descriptioncardtextinner">
                when we started in,2020,Gusei was just a company with a fun name
                and a big dream. we wanted to bring music back to its roots and
                empower anyone to join in .Todaywe're a vibrant,global community
                of music lovers where millions of people across the world come
                together each day to share their passion for music, make new
                friends,cheer each other on, and simply have fun
              </div>
            </div>
            <div className="descriptioncardtext">
              <div className="descriptioncardtextinner">
                If anyone love music ,wake up humming, play a mean air
                guitar,cant't stop singing in the shower, or dream of rocking
                out in a punk ukulele band,join us who knows might just find
                your harmonious doppelganger or melodic twin seperated at birth.
