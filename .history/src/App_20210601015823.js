      ...
      <div className="section4">
        ...
        <div className="subtitle">
          <div className="subtitleinner">
            <p>We are a technology-driven media company focused on music. We help</p><br />
            <p>undiscovered talent achieve the fame they deserve.</p>
          </div>
        </div>

        <div className="descriptioncard">
          <div className="descriptioncardinner"> </div>
        </div>
      </div>
    </div>
  );
