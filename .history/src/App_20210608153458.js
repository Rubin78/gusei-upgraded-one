 ...
 */}
            ...
            <div>
              <Row className="">
                <div className="col-md-3 col-sm-12 footerbottom">Terms & Conditions</div>
                <div className="col-md-2 col-sm-12 footerbottom">Privacy</div>
                <div className="col-md-2 col-sm-12 footerbottom">Cookies</div>
                <div className="col-md-2 col-sm-12 footerbottom">Copyright </div>
                <div className="col-md-3 col-sm-12 footerbottom">Acknowledgments</div>
              </Row>
            </div>
