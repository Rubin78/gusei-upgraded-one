          ...
          <div className="descriptioncardinner">
            ...
            <div className="descriptioncardtext">
              <div className="descriptioncardtextinner">
                music is more than just listening-music also include creating.
                sharing,discovering,participating and connecting.Music is the
                original social network with the power to break down
                barries,touch,souls,and bring people from all over the world
                together.
              </div>
            </div>
            <div className="descriptioncardtext">
            ...
            <div className="descriptioncardtext">
              <div className="descriptioncardtextinner"></div>
              If anyone love music ,wake up humming, play a mean air
              guitar,cant't stop singing in the shower, or dream of rocking out
              in a punk ukulele band,join us who knows might just find your
              harmonious doppelganger or melodic twin seperated at birth. Anyone
              can do it .No Previous experience required. letss music together.
            </div>
          </div>
