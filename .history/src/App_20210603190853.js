          ...
          <Row>
            <div className="col-md-6">
              <div className="col-12 col-sm-12">
                <Row>
                  <div className="col-3 col-sm-6 sqaurecardimg">
<img src={buttoncard1} />                  </div>
                  <div className="col-3 col-sm-4 sqaurecardimg">
