                    ...
                    play2
                                    ...
                                    <Modal
                                        ...
                                        <Modal.Footer>
                                            ...
                                            <button className="modalplaybtn" onClick={myfavhandler}>{isplaying ? <PauseCircleOutlineOutlinedIcon style={{ fontSize: 65 }} /> : <PlayCircleFilledOutlinedIcon style={{ fontSize: 65 }} />}</button>
