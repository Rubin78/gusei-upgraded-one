...
import Alltimefavourite from "../src/component/Alltimefavourite"
import Myfavourhandler from "../src/component/Myfavourite"
...
import Myfavourite from "../src/component/Myfavourite";
 ...
 */
  ...
  const Myfavourhandler = (e) => {
    ...
    axios
      ...
      myFavsongsService.getMyFavor().then(data=>{
        setData(data);
        setSelectbutton("Myfavour")
        alert("hello")
  ...
  const Genrehandler = (e) => {
   /*  e.preventDefault();
    ...
    axios
      ...
      myGenresongsService.getGenre().then(data=>{
        setData(data);
        setSelectbutton("Genre")
        alert("hello")
          ...
          <div className="row">
            ...
            >
              <div className="imagecontent">
                <a href="https://www.facebook.com/gusei.gusei.7" className="imagecontentinside">
                  <img
              ...
              <div className="imagecontent">
                <a href="https://www.instagram.com/gusei2022/" className="imagecontentinside">
                  <img
                    className="socialmediaimage "
              ...
              <div className="imagecontent">
                <a href="https://twitter.com/gusei2022" className="imagecontentinside">
                  <img
                    className="socialmediaimage "
              ...
              <div className="imagecontent">
                <a href="https://www.youtube.com/channel/UCBaZVzOM21EUaohHyneKnew" className="imagecontentinside">
                  <img
                    className="socialmediaimage "
